...
//		- ПереведитьВМонопольныйРежим - Булево - Флаг того, надо ли переводить базу в монопольный режим перед восстановлением
...
//		- Ложь - Если были ошибки
//	
Функция ВосстановитьИзРезервнойКопииБД(МассивИменаФайлов, ТаблицаФайловБДИсточника="", ПереводитьБДВМонопольныйРежим=Ложь, МоментВремени=Неопределено) Экспорт
